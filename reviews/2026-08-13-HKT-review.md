...
逐日核对 `signals/*-HKT-signals.md` + `actions/*-HKT-actions.md` 两目录全部 23 个 HKT 文件（signals 17 个 + actions 6 个），与上一版 CSV（08-07，37 笔）逐日比对。**发现 08-10、08-12、08-13 有 4 笔新交易未入样本**，本次补齐。关键对账结论：
...
- **止盈端**：浮盈大时没让利润充分奔跑就主动平 / 移损过紧被扫（如 08-07 MINIMAX 浮盈 +4.65R 落地 1.96R——源口径 1.96R（复盘口径 +2.01R，见 8.3 表；两口径差异源于源记录与 CSV 复盘重算的手续费 / 触发价取数不同，本文 8.3 表与第 374 行并存的两种数值均有效，引用时注明口径））。
